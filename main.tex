...
\thesissetup{
    ...
    keywords      = {nahrávanie obrázkov, webový server, javascript, webová komponenta, canvas},
    TeXkeywords   = {nahrávanie obrázkov, webový server, javascript, webová komponenta, canvas},
}
\thesislong{abstract}{
